...
export declare type Category = "FUN" | "SETTINGS";
...
export default abstract class Command {
  ...
  constructor(args: CommandArgs) {
    ...
    this._myPermissions = this._myPermissions;
  }
  ...
  public abstract execute(interaction: ChatInputCommandInteraction | Message, client: Bot): any;
}
